...
module par_mod
  ...
  real,parameter :: hmixmin=100., hmixmax=2500., turbmesoscale=0.16
  ...
  integer,parameter :: nxmax=512,nymax=512,nuvzmax=45,nwzmax=45,nzmax=45
  !integer,parameter :: nxmax=300,nymax=300,nuvzmax=61,nwzmax=61,nzmax=61
  ...
  integer,parameter :: maxreceptor=10000
