...
############## NETCDF library path #################
#NETCDF = /sw/rhel6-x64/netcdf/netcdf_c-4.4.0-parallel-openmpi2-gcc64
#NETCDF2 = /sw/rhel6-x64/netcdf/netcdf_fortran-4.4.3-parallel-openmpi2-gcc64
#MPI_ROOT = /sw/rhel6-x64/mpi/openmpi-2.0.2p2_hpcx-gcc64

# NetCDF library version 3 or 4. Version 4 is much better for compression
NETCDFVERSION=4
NETCDF =  /n/home03/jbushey/spack/var/spack/environments/ncview_env_new/.spack-env/view
...
#GNU_FFLAGS  = -g -m64 -fbacktrace -fbounds-check -mcmodel=medium -fconvert=little-endian -finit-local-zero -fno-range-check
#GNU_LDFLAGS = -g -m64 -fbacktrace -fbounds-check -mcmodel=medium -fconvert=little-endian -finit-local-zero -lnetcdff -lnetcdf -fno-range-check
GNU_FFLAGS  = -O2 -mcmodel=medium -fno-range-check
GNU_LDFLAGS = -O2 -mcmodel=medium -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lcurl -lz
#-O3
...
INTEL_FFLAGS  = -O2 -cpp -auto -mcmodel=medium -shared-intel -g -debug extended -traceback 
INTEL_LDFLAGS = -O2 -cpp -auto -mcmodel=medium -shared-intel -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lcurl -lz
